...
context('UI', () => {
    ...
    describe(' ACI Biiling Workflow 2 - Monthly Flat Fee', () => {
        var login = false;
        var workflowName = 'test workflow for ACI billing rule 2';
        ...
        beforeEach(() => {
            cy.loginToAutotecUI({        //Login to autotec dev url 
                email: Cypress.env('usernameaci2'),
                password: Cypress.env('passwordaci2')
            })
        })
