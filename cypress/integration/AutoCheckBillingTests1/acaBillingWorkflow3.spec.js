...
context('UI', () => {
    ...
    describe('ACA Exception Max Billing Workflow 3', () => {
        var login = false;
        var workflowName = 'test workflow for ACA standard billing rule 3';
        ...
        beforeEach(() => {
            cy.loginToAutotecUI({ //Login to autotec dev url 
                email: Cypress.env('usernameaca3'),
                password: Cypress.env('passwordaca3')
            })
        })
