...
context('UI', () => {
    ...
    describe('ACI Billing Workflow 1 - Support for Flat Rate', () => {
        var login = false;
        var workflowName = 'test workflow for ACI billing rule 1';
        ...
        beforeEach(() => {
            cy.loginToAutotecUI({ //Login to autotec dev url 
                email: Cypress.env('usernameaci1'),
                password: Cypress.env('passwordaci1')
            })
            cy.selectLocationForCustomer();
        })
