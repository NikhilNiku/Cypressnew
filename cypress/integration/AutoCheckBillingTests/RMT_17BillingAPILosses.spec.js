...
context('UI', () => {
    describe('RMT-17 RMT Billing API "loses" workflow executions', () => {
        ...
        it('checks for loss of workflow', () => {
            ...
            cy.get('div > div > span > :nth-child(2) > span > span > input').click({
                force: true
            }); //unchecking Ready for approval
            cy.get('div > div > span > :nth-child(4) > span > span > input').click({
                force: true
            }); //checking Running
            cy.wait(240000)
            ...
            cy.get('div > table > tbody > :nth-child(1) > td > span > span > input', {
                ...
                force: true
            }); //checking first workflow
            cy.get('div > table > tbody > :nth-child(2) > td > span > span > input').click({
                force: true
            }); //checking second workflow
            cy.get('div > table > tbody > :nth-child(3) > td > span > span > input').click({
                force: true
            }); //checking third workflow
            ...
            cy.get('div > div > div > button').contains('Generate Invoice').click({
                force: true
