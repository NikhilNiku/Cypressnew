...
context('API', () => {
	describe('One VIN - ACA COMPROMISED REPORT', () => {
		it('returns Compromised Report - Happy Path - ACA', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/compromised',
					headers: {
				...
				.as('getCompromisedReport');
			cy.get('@getCompromisedReport').should((response) => {
				expect(response.status).to.eq(200);
                expect(response.body).to.have.property('level', 'COMPROMISED');
		...
		it('returns Compromised Report - Lower Case Letters in VIN', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/compromised',
		...
		it('fails to return Compromised Report - Invalid Token', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/compromised',
		...
		it('fails to return Compromised Report - Invalid Request', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/compromised',
	...
	describe('Ten VINs - COMPROMISED REPORT', () => {
		it('returns 10 compromised reports', () => {
			2;
			cy
				.request({
					method: 'POST',
