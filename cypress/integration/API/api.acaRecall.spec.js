...
context('API', () => {
	describe('One VIN - ACA FULL REPORT', () => {
		it('returns Recall Report - Happy Path - ACA', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/recall',
					headers: {
			...
			cy.get('@getRecallReport').should((response) => {
				...
				expect(response.body).to.have.property('level', 'RECALL');
		...
		it('returns Recall Report - Lower Case Letters in VIN', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/recall',
		...
		it('fails to return Recall Report - Invalid Token', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/recall',
		...
		it('fails to return Recall Report - Invalid Request', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/recall',
