...
context('API', () => {
	describe('One VIN - ACA ANNOUNCEMENT REPORT', () => {
		it('returns Announcement Report - Happy Path - ACA', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/announcement',
					headers: {
				...
				.as('getAnnouncementReport');
			cy.get('@getAnnouncementReport').should((response) => {
				expect(response.status).to.eq(200);
                expect(response.body).to.have.property('level', 'HISTORICAL');
		...
		it('returns Announcement Report - Lower Case Letters in VIN', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/announcement',
		...
		it('fails to return Announcement Report - Invalid Token', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/announcement',
		...
		it('fails to return Announcementt Report - Invalid Request', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/announcement',
	...
	describe('Ten VINs - ANNOUNCEMENT REPORT', () => {
		it('returns 10 announcement reports', () => {
			2;
			cy
				.request({
					method: 'POST',
