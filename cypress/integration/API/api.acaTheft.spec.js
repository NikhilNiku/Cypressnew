...
context('API', () => {
	describe('One VIN - ACA THEFT REPORT', () => {
		it('returns Theft Report - Happy Path - ACA', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/theft',
					headers: {
				...
				.as('getTheftReport');
			cy.get('@getTheftReport').should((response) => {
				expect(response.status).to.eq(200);
				expect(response.body).to.have.property('level', 'THEFT');
		...
		it('returns Theft Report - Lower Case Letters in VIN', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/theft',
		...
		it('fails to return Theft Report - Invalid Token', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/theft',
		...
		it('fails to return Theft Report - Invalid Request', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/theft',
	...
	describe('Ten VINs - THEFT REPORT', () => {
		it('returns 10 theft reports', () => {
			2;
			cy
				.request({
					method: 'POST',
