...
context('API', () => {
	describe('One VIN - ACA ACCIDENT REPORT', () => {
		it('C33047 returns Accident Report - Happy Path - ACA', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/accident',
					headers: {
				...
				.as('getAccidentReport');
			cy.get('@getAccidentReport').should((response) => {
				expect(response.status).to.eq(200);
				expect(response.body).to.have.property('level', 'ACCIDENT');
		...
		it('returns Accident Report - Lower Case Letters in VIN', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/accident',
		...
		it('fails to return Accident Report - Invalid Token', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/accident',
		...
		it('fails to return Accident Report - Invalid Request', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/accident',
	...
	describe('Ten VINs - ACCIDENT REPORT', () => {
		it('returns 10 accident reports', () => {
			2;
			cy
				.request({
					method: 'POST',
