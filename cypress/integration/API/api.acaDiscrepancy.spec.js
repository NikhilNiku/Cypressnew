...
context('API', () => {
	describe('One VIN - ACA DISCREPANCY', () => {
		it('returns Discrepancy Report - Happy Path - ACA', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/discrepancy',
					headers: {
				...
				.as('getDiscrepancyReport');
			cy.get('@getDiscrepancyReport').should((response) => {
		...
		it('returns Discrepancy Report - Lower Case Letters in VIN', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/discrepancy',
		...
		it('fails to return Discrepancy Report - Invalid Token', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/discrepancy',
		...
		it('fails to return Discrepancy Report - Invalid Request', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/discrepancy',
	...
	describe('Ten VINs - DISCREPANCY REPORT', () => {
		it('returns 10 discrepancy reports', () => {
			2;
			cy
				.request({
					method: 'POST',
