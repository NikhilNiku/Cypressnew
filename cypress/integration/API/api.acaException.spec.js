...
context('API', () => {
	describe('One VIN - ACA EXCEPTION REPORT', () => {
		it('returns Exception Report - Happy Path - ACA', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/exception',
					headers: {
				...
				.as('getExceptionReport');
			cy.get('@getExceptionReport').should((response) => {
				expect(response.status).to.eq(200);
				expect(response.body).to.have.property('level', 'EXCEPTION');
		...
		it('returns Exception Report - Lower Case Letters in VIN', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/exception',
		...
		it('fails to return Exception Report - Invalid Token', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/exception',
		...
		it('fails to return Exception Report - Invalid Request', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/exception',
	...
	describe('Ten VINs - EXCEPTION REPORT', () => {
		it('returns 10 exception reports', () => {
			2;
			cy
				.request({
					method: 'POST',
