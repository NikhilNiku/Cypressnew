...
context('API', () => {
	describe('One VIN - ACA DISASTER REPORT', () => {
		it('returns Disaster Report - Happy Path - ACA', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/disaster',
					headers: {
				...
				.as('getDisasterReport');
			cy.get('@getDisasterReport').should((response) => {
				expect(response.status).to.eq(200);
                expect(response.body).to.have.property('level', 'DISASTER');
		...
		it('returns Disaster Report - Lower Case Letters in VIN', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/disaster',
		...
		it('fails to return Disaster Report - Invalid Token', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/disaster',
		...
		it('fails to return Disaster Report - Invalid Request', () => {
			cy
				.request({
					method: 'POST',
					url: Cypress.env('acaApi') + 'vehicle/history/disaster',
	...
	describe('Ten VINs - DISASTER REPORT', () => {
		it('returns 10 disaster reports', () => {
			2;
			cy
				.request({
					method: 'POST',
